...
#    Updated: 2016/11/28 12:51:45 by skholodn         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
NAME = libft.a

SRC = ./ft_atoi.c ./ft_itoa.c ./ft_putchar_fd.c ./ft_putchar.c \
			...
			./ft_strncmp.c ./ft_strncpy.c ./ft_strnstr.c ./ft_strstr.c \
			...
			./ft_strsplit.c ft_arrdel.c ft_strsplit.c ./ft_arrdel.c \
			./ft_lstnew.c ./ft_lstdelone.c ./ft_lstdel.c \
			./ft_lstadd.c ./ft_lstiter.c ./ft_lstmap.c ./ft_swap.c \
			./ft_lstlen.c ./ft_strrev.c
OBJ = ./ft_atoi.o ./ft_itoa.o ./ft_putchar_fd.o ./ft_putchar.o \
			...
			./ft_strsplit.o ft_arrdel.o ft_strsplit.o ./ft_arrdel.o \
			./ft_lstnew.o ./ft_lstdelone.o ./ft_lstdel.o \
			./ft_lstadd.o ./ft_lstiter.o ./ft_lstmap.o ./ft_swap.o \
			./ft_lstlen.o ./ft_strrev.o
HEAD = ./libft.h
...
$(NAME): $(OBJ)
	ar rc $(NAME) $(OBJ)
	gcc -Wall -Wextra -Werror -c -I$(HEAD) $(SRC)
	ar rc $(NAME) $(OBJ)

%.o: ./%.c
	gcc -Wall -Wextra -Werror -o $@ -c -I$(HEAD) $<
